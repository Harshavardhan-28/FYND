                  ...
                  <ReactMarkdown
                    components={{
                      ...
                      h2: ({ node, ...props }) => {
                        ...
                        return (
                          <h2
                            className="text-lg font-semibold text-purple-700 mt-6 mb-3 flex items-center gap-2"
                            {...props}
                          />
                        );
                      },
                      ...
                      blockquote: ({ node, ...props }) => {
                        ...
                        return (
                          <blockquote
                            className="border-l-4 border-purple-200 pl-4 italic text-gray-600 my-4"
                            {...props}
                          />
                        );
                      },
